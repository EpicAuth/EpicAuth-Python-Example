...
If that doesn't work for you, you can paste the contents of EpicAuth.py ABOVE this comment and then remove the "from EpicAuth import api" and that should work too.

READ HERE TO LEARN ABOUT EpicAuth FUNCTIONS https://github.com/EpicAuth/EpicAuth-Python-Example#EpicAuthapp-instance-definition
'''
from EpicAuth import api
...
4.License Key Only
        ...
        if ans == "1":
            ...
            EpicAuthapp.login(user, password, code)
        elif ans == "2":
            user = input('Provide username: ')
            password = input('Provide password: ')
...
print("\nApplication data: ")
print("App Version: " + EpicAuthapp.app_data.app_ver)
print("Customer Panel Link: " + EpicAuthapp.app_data.customer_panel)
print("Number of Keys: " + EpicAuthapp.app_data.numKeys)
print("Number of Users: " + EpicAuthapp.app_data.numUsers)
print("Online Users: " + EpicAuthapp.app_data.onlineUsers)
...
if tfaans == "1":
    EpicAuthapp.enable2fa()  # You only need to call this once as it's called in the API file. 
elif tfaans == "2":
    EpicAuthapp.disable2fa()  # You only need to call this once as it's called in the API file, and should ideally only need to be called once anyways. 
else:
    print("\nInvalid Option")
